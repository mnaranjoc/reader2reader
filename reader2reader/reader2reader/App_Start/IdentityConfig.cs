...
namespace reader2reader
{
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            string username = "admin@reader2reader.com";
            ...
            // Create Admin role
            IdentityRole role = context.Roles.Where(x => x.Name == Constants.RoleAdmin).FirstOrDefault();
            if (role == null)
            {
            ...
            // Create Admin role
            role = context.Roles.Where(x => x.Name == Constants.RoleUser).FirstOrDefault();
            if (role == null)
            {
                role = new IdentityRole
                {
